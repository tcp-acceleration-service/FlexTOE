...
# The PCI base class for all Netronome Agilio devices
nfp_class = {'Class': '02', 'Vendor': '19ee', 'Device': '4000,6000',
             'SVendor': None, 'SDevice': None}

network_devices = [nfp_class]

# global dict ethernet devices present. Dictionary indexed by PCI address.
# Each device within this is itself a dictionary of device properties
devices = {}
# list of supported DPDK drivers
dpdk_drivers = ["flextoe_uio"]
...
def check_modules():
    '''Checks that flextoe_uio is loaded'''
    global dpdk_drivers
...
def get_device_details(devices_type):
    ...
    for d in devices.keys():
        ...
        # add flextoe_uio to list of supporting modules if needed
...
def show_status():
    ...
    Displays to the user what devices are bound to the flextoe_uio driver, the
...
""")
    ...
    parser.add_argument(
        ...
        '--status',
        action='store_true',
        help="Print the current status of all known Netronome devices.")
